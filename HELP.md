...
* The original package name 'com.example.Login and Registration Backend + Email Verification' is invalid and this project uses 'com.example.Login.and.Registration.Backend.Email.Verification' instead.
